...
export function MobileNav() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-50 border-t border-[var(--nm-line)] bg-[var(--nm-surface)]/95 backdrop-blur-md md:hidden"
            ...
            <li key={href}>
              <Link
                ...
                className={[
                  ...
                  active ? 'text-[var(--nm-accent)]' : 'text-[var(--nm-muted)]',
                ].join(' ')}
              >
